...
def test_get_lines_empty_string() raises:
...
# def test_get_lines_view() raises:
...
# def test_get_lines_view_trailing_newlines() raises:
#     lines, widest_line = get_lines_view("hello\nworld\n\n\n\n\n")
...
# def test_get_lines_view_empty_string() raises:
